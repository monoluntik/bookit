  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-8 max-w-sm w-full text-center shadow-sm">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-1">Оплата не прошла</h1>
        <p className="text-gray-500 text-sm mb-6">Попробуйте ещё раз или выберите другой способ оплаты.</p>
