    ...
    <div>
      ...
      {meta.total > 0 && (
        <div className="bg-white rounded-2xl p-5 shadow-sm mb-4 flex gap-6 items-center">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">{meta.total} отзывов</div>
          </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl p-12 text-center">
          ...
          <p className="text-sm text-gray-400 mt-1">Они появятся после завершённых посещений</p>
        </div>
      ) : (
            ...
            <div key={r.id} className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-800">{r.customer?.name ?? 'Клиент'}</div>
              ...
              {r.reply && replyingTo !== r.id && (
                <div className="mt-3 ml-4 pl-3 border-l-2 border-blue-100">
                  <div className="text-xs font-semibold text-blue-700 mb-0.5">Ответ владельца:</div>
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      {submitting ? 'Отправляем...' : 'Опубликовать ответ'}
                    </button>
                    <button
