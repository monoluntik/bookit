...
const TYPE_LABELS: Record<string, string> = {
  HOTEL: 'Отель', RESTAURANT: 'Ресторан', SALON: 'Салон',
...
export default function AdminBusinessesPage() {
  ...
  const toggleStatus = async (id: string, isActive: boolean) => {
    ...
    try {
      ...
      success(isActive ? 'Бизнес активирован' : 'Бизнес деактивирован')
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-5">
        <form onSubmit={handleSearch} className="flex gap-2 flex-1 min-w-48">
          ...
          />
          <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-xl text-sm hover:bg-blue-700">Найти</button>
        </form>
            ...
            <div key={b.id} className="bg-gray-800 rounded-2xl border border-gray-700 p-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-gray-500 mt-0.5 flex gap-3">
                  ...
                  <span>{b._count?.bookings ?? 0} броней</span>
                  <span>{b._count?.reviews ?? 0} отзывов</span>
                  <span>{b._count?.resources ?? 0} ресурсов</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  {b.isActive ? 'Скрыть' : 'Активировать'}
                </button>
              </div>
            </div>
          ))}
