...
export default function AdminReviewsPage() {
  ...
  const deleteReview = async (id: string) => {
    ...
    } catch { showError(t('toasts.deleteError')) }
  }
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 flex-wrap">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-white">{r.customer?.name ?? t('defaultCustomer')}</span>
                    </div>
                  ...
                  {r.reply && (
                    <div className="mt-2 pl-3 border-l-2 border-blue-700">
                      <span className="text-xs text-blue-400 font-semibold">{t('ownerReply')} </span>
